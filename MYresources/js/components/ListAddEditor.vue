<template>
  <div>
    ...
    <div 
      @click="startEditing" 
      v-if="!editing "
      class="list bg-white hover:bg-gray-500 rounded-sm p-2 mr-2 opcaity-75 text-black cursor-pointer"
    >＋&nbsp;Add New List
    </div>
    <div 
      v-else 
...
export default {
  ...
  methods: {
    ...
    startEditing() {
      ...
      // this.$refs.title.focus(); // this will not work with v-if hiding and showing items; $ref items are only available after rendering
      // to solve use $nextTick
